...
@Component({
  selector: 'app-hicharts-component',
  templateUrl: './hicharts-component.component.html',
  styleUrls: ['./hicharts-component.component.scss']
})
export class HichartsComponentComponent implements OnInit, AfterViewInit  {
